...
public interface SettingRepository extends JpaRepository<Setting, Long> {
    ...
    Optional<String> updateValueBySettingTypeAndAccountId(@Param("accountId") long accountId, @Param("type") String type, @Param("value") String value);

    @Query("select s.value from Setting s where s.account.id = :accountId")
